...
export default function LoginModal({ onClose, onLogin }) {
  ...
  async function submit() {
    if (!user.trim() || !pass) { setErr('Please enter username and password.'); return }
      ...
      <div className={s.box}>
        ...
        <div className={s.body}>
          ...
          <div className={s.field}>
            ...
            <input ref={ref} value={user} onChange={e => setUser(e.target.value)}
              placeholder="e.g. staff01" onKeyDown={e => e.key === 'Enter' && submit()}
              disabled={loading} />
          </div>
          <div className={s.field}>
